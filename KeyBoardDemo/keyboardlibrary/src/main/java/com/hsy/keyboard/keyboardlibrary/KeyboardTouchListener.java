...
public class KeyboardTouchListener implements View.OnTouchListener {
    ...
    public KeyboardTouchListener(KeyboardUtil util, int keyboardType, int scrollTo, boolean isUpper) {
        this.keyboardUtil = util;
        this.keyboardType = keyboardType;
        this.scrollTo = scrollTo;
        this.keyboardUtil.isUpper = isUpper;
    }
