package com.hsy.keyboard.keyboardlibrary;
...
public class KeyboardUtil {
    ...
    public boolean isUpper = false;//开始显示是否大写
    ...
    public TextView getKeyboard_tips_tv() {
        return keyboard_tips_tv;
    }

    public void setTitleHint(String string) {
        this.keyboard_tips_tv.setText(string);
    }
     ...
     * @param ctx
     */
    public KeyboardUtil(Context ctx, View view) {
        this.mView = view;
        this.mContext = ctx;
        this.mActivity = (Activity) mContext;
        widthPixels = mContext.getResources().getDisplayMetrics().widthPixels;
     ...
     */
    public KeyboardUtil(View view, Context ctx) {
    ...
    private void initKeyBoardView() {
        ...
        if (mView != null) {
            ...
            frameLayout = (FrameLayout) this.mActivity.getWindow().getDecorView();
        }
        ...
        initLayoutHeight((RelativeLayout) keyBoardLayout);
        ...
        frameLayout.addView(keyBoardLayout, lp);
        keyBoardLayout.setAnimation(AnimationUtils.loadAnimation(mActivity, R.anim.down_to_up));
        if (keyBoardLayout != null && keyBoardLayout.getVisibility() == View.VISIBLE)
            Log.d("KeyboardUtil", "visible");
    }


    public void initLayoutHeight(RelativeLayout layoutView) {
        RelativeLayout.LayoutParams keyboard_layoutlLayoutParams = (RelativeLayout.LayoutParams) layoutView
                .getLayoutParams();
        ...
        ImageView keyboard_view_finish = (ImageView) layoutView.findViewById(R.id.keyboard_view_finish);
